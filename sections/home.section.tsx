...
function HomeSection() {
  const ctaLinks = {
    contact: [
      ...
      "px-5 py-3",
      "mr-3",
      "font-medium text-base text-center text-white hover:text-logo-shade4",
      "outline-none outline-offset-4 focus:outline-2 focus:text-logo-shade4 dark:focus:outline-logo-shade4",
      "bg-gray-700",
      "rounded-sm",
    ].join(" "),
    download: [
      ...
      "outline-none outline-offset-4 focus:outline-2 focus:border-transparent dark:focus:outline-logo-shade4 focus:bg-logo-shade4",
