...
function HomeSection() {
  const ctaLinks = {
    contact: [
      ...
      "outline-none outline-offset-3 focus:outline-2 focus:text-logo-shade1 dark:focus:text-logo-shade1 focus:outline-logo-shade1 dark:focus:outline-logo-shade1",
    ...
    download: [
      ...
      "outline-none outline-offset-3 focus:outline-2 focus:border-transparent focus:outline-logo-shade4 focus:bg-logo-shade4",
