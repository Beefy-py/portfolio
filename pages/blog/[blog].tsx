              ...
              <header className="grid grid-cols-1 md:grid-cols-2 items-center justify-between">
                <div className="mb-4 lg:mb-6 not-format flex justify-between flex-col">
                  ...
                  <div className="">
                    ...
                    <div className="flex items-center w-3/4 flex-wrap">
                      {/*Facebook */}
                      <FacebookShareButton
                        url={shareUrl}
                        quote="Special Quote"
                        hashtag={`#${post.categories[0].title}`}
                        children={
                          <div className="mr-2 bg-[#1877f2] inline-block rounded px-6 py-2.5 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg">
                            <svg
                      ...
                      <LinkedinShareButton
                        ...
                        children={
                          <div className="mr-2 bg-[#0077b5] inline-block rounded px-6 py-2.5 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              className="h-4 w-4"
                              fill="currentColor"
                      ...
                      {/*Pinterest */}
                      <PinterestShareButton
                        media={urlForSanityImage(post.mainImage)
                          .width(400)
                          .url()}
                        description={post.excerpt}
                        url={shareUrl}
                        children={
                          <div className="mr-2 bg-[#e60023] inline-block rounded px-6 py-2.5 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              className="h-4 w-4"
                              fill="currentColor"
                      ...
                      <TelegramShareButton
                        ...
                        url={shareUrl}
                        children={
                          <div className="mr-2 bg-[#0088cc] inline-block rounded px-6 py-2.5 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg">
                            <svg
                              className="h-4 w-4"
                              fill="currentColor"
                              viewBox="0 0 24 24"
                      ...
                      <RedditShareButton
                        ...
                        url={shareUrl}
                        children={
                          <div className="mr-2 bg-[#ff4500] inline-block rounded px-6 py-2.5 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              className="h-4 w-4"
                              fill="currentColor"
                      ...
                      <TwitterShareButton
                        title={post.title}
                        hashtags={post.categories.map((item) => item.title)}
                        url={shareUrl}
                        children={
                          <div className="mr-2 bg-[#1da1f2] inline-block rounded px-6 py-2.5 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              className="h-4 w-4"
                              fill="currentColor"
                      ...
                      <WhatsappShareButton
                        ...
                        url={shareUrl}
                        children={
                          <div className="mr-2 bg-[#128c7e] inline-block rounded px-6 py-2.5 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              className="h-4 w-4"
                              fill="currentColor"
